...
def create_dispatcher() -> Dispatcher:
    ...
    # updates from the configured admin chat. admin_reply has no FSM-state filter, so a
    # swipe-reply always works immediately, regardless of any pending admin flow.
