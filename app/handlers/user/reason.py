...
@router.callback_query(ConfirmNewTicket.confirm, F.message.chat.type == "private")
...
@router.callback_query(UserFlow.choosing_reason, F.message.chat.type == "private")
...
@router.callback_query(UserFlow.choosing_purchase_subcategory, F.message.chat.type == "private")
