...
@router.message(IsAdminChat(), IsAdmin(), RequisitesFlow.entering_amount, ~F.text.startswith("/"))
...
@router.callback_query(IsAdminChat(), IsAdmin(), F.data.startswith("reqamount:"))
...
@router.callback_query(IsAdminChat(), IsAdmin(), F.data.startswith("reqcomment:"))
...
@router.message(IsAdminChat(), IsAdmin(), RequisitesFlow.editing_comment, ~F.text.startswith("/"))
...
@router.callback_query(IsAdminChat(), IsAdmin(), F.data.startswith("reqcancel:"))
...
@router.callback_query(IsAdminChat(), IsAdmin(), F.data.startswith("reqsend:"))
