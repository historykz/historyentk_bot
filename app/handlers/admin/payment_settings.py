...
@router.callback_query(IsAdminChat(), IsAdmin(), F.data.startswith("psettings:"))
...
@router.callback_query(IsAdminChat(), IsAdmin(), F.data.startswith("pedit:"))
...
@router.message(IsAdminChat(), IsAdmin(), PaymentSettingsFlow.awaiting_photo, F.photo)
