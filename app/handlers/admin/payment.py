...
@router.callback_query(IsAdminChat(), IsAdmin(), F.data.startswith("payeditamount:"))
...
@router.message(IsAdminChat(), IsAdmin(), ConfirmPaymentFlow.editing_amount, ~F.text.startswith("/"))
...
@router.callback_query(IsAdminChat(), IsAdmin(), F.data.startswith("paycancelflow:"))
...
@router.callback_query(IsAdminChat(), IsAdmin(), F.data.startswith("payconfirm:"))
...
@router.callback_query(IsAdminChat(), IsAdmin(), F.data.startswith("payreject:"))
...
@router.callback_query(IsAdminChat(), IsAdmin(), F.data.startswith("payretry:"))
...
@router.message(IsAdminChat(), IsAdmin(), CancelPaymentFlow.awaiting_reason, ~F.text.startswith("/"))
