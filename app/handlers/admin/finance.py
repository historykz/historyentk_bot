...
@router.message(IsAdminChat(), IsAdmin(), HistoryLookup.awaiting_period_start, ~F.text.startswith("/"))
...
@router.message(IsAdminChat(), IsAdmin(), HistoryLookup.awaiting_period_end, ~F.text.startswith("/"))
